...
public final class SwerveDrivetrain extends AbstractSubsystem {
    ...
    /** Field re-orient for starts where the robot faces the driver station (i.e., 180° from field +X). */
    ...
    public void start() {
        clearFaults();
        // no auto-zero here; we do a deliberate orientation from Robot at mode start
    }
